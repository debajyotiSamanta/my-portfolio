export default function Footer() {
  ...
  return (
    <footer className="relative bg-gradient-to-b from-white via-slate-50 to-gray-100 dark:from-gray-900 dark:via-gray-900 dark:to-gray-950 border-t border-gray-200 dark:border-gray-800 transition-colors animate__animated animate__fadeInUp overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12">
            ...
            <div className="space-y-5 animate__animated animate__fadeInUp">
              <div>
                <div className="inline-flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-gray-900 dark:text-white">DEBAJYOTI SAMANTA</p>
              ...
              <div className="space-y-3 pt-3 border-t border-gray-200 dark:border-gray-800">
                <p className="text-sm font-semibold text-gray-900 dark:text-white uppercase tracking-wider">Follow On Social</p>
              ...
              <ul className="space-y-3">
                {footerSections.Navigation.map((link) => (
                  <li key={link.href}>
                    <a
                      href={link.href}
                      className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-300 text-sm font-light flex items-center gap-3 group hover:translate-x-1"
                    >
                  ...
                  <li key={i}>
                    {item.link ? (
                      <a
                        ...
                        className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-300 text-sm font-light flex items-start gap-3 group"
                      >
                        ...
                        <div className="group-hover:translate-x-1 transition-transform">
                          <p className="text-xs text-gray-500 dark:text-gray-500 uppercase tracking-wider mb-0.5">{item.label}</p>
                          <p className="break-all">{item.value}</p>
                        </div>
                      </a>
                    ) : (
                      <div className="text-gray-600 dark:text-gray-400 text-sm font-light flex items-start gap-3">
          ...
          <div className="animate__animated animate__fadeInUp" style={{ animationDelay: "0.4s" }}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-sm text-gray-600 dark:text-gray-400 font-light">
